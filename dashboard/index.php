...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
            ...
            <div class="sidebar-brand-text mx-3">Internship <sup>2</sup></div>
        </a>
        ...
        <!-- Nav Item - Skill Tracker -->
        <li class="nav-item">
            <a class="nav-link" href="">
                <i class=""></i>
                <span>Skill Tracker</span></a>
        </li>
        <!-- Nav Item - Rewards -->
        <li class="nav-item">
            <a class="nav-link" href="">
        ...
        <li class="nav-item">
            ...
            <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="http://localhost/dashboard/login.php">Login</a>
                    <a class="collapse-item" href="http://localhost/dashboard/register.php">Register</a>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo $name." ".$last_name?></span>
